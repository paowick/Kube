...
3. #### Start minikube
    ...
    >:memo:**_NOTE:_**
    You can use another driver to run minikube such as: Hyper-V,VirtualBox,VMware or [anything else](#requirement)
...
<img src="./src/result_traefik_http.jpg" width="640" height="350"> \
Use **http://web.spcn23.local/** for rancher web \
